...
static const comedi_lrange range_dt282x_ai_lo_bipolar = {
	4,
	{
		RANGE(-10, 10),
		RANGE(-5, 5),
...
static const comedi_lrange range_dt282x_ai_lo_unipolar = {
	4,
	{
		RANGE(0, 10),
		RANGE(0, 5),
...
static const comedi_lrange range_dt282x_ai_5_bipolar = {
	4,
	{
		RANGE(-5, 5),
		RANGE(-2.5, 2.5),
...
static const comedi_lrange range_dt282x_ai_5_unipolar = {
	4,
	{
		RANGE(0, 5),
		RANGE(0, 2.5),
...
static const comedi_lrange range_dt282x_ai_hi_bipolar = {
	4,
	{
		RANGE(-10, 10),
		RANGE(-1, 1),
...
static const comedi_lrange range_dt282x_ai_hi_unipolar = {
	4,
	{
		RANGE(0, 10),
		RANGE(0, 1),
