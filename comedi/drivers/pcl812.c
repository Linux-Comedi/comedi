...
static const comedi_lrange range_pcl812pg_ai = {
	5,
	{
		BIP_RANGE(5),
		BIP_RANGE(2.5),
...
static const comedi_lrange range_pcl812pg2_ai = {
	5,
	{
		BIP_RANGE(10),
		BIP_RANGE(5),
...
static const comedi_lrange range812_bipolar1_25 = {
	1,
	{
		BIP_RANGE(1.25),
	},
};
static const comedi_lrange range812_bipolar0_625 = {
	1,
	{
		BIP_RANGE(0.625),
	},
};
static const comedi_lrange range812_bipolar0_3125 = {
	1,
	{
		BIP_RANGE(0.3125),
	},
};
static const comedi_lrange range_pcl813b_ai = {
	4,
	{
		BIP_RANGE(5),
		BIP_RANGE(2.5),
...
static const comedi_lrange range_pcl813b2_ai = {
	4,
	{
		UNI_RANGE(10),
		UNI_RANGE(5),
...
static const comedi_lrange range_iso813_1_ai = {
	5,
	{
		BIP_RANGE(5),
		BIP_RANGE(2.5),
...
static const comedi_lrange range_iso813_1_2_ai = {
	5,
	{
		UNI_RANGE(10),
		UNI_RANGE(5),
...
static const comedi_lrange range_iso813_2_ai = {
	4,
	{
		BIP_RANGE(5),
		BIP_RANGE(2.5),
...
static const comedi_lrange range_iso813_2_2_ai = {
	4,
	{
		UNI_RANGE(10),
		UNI_RANGE(5),
...
static const comedi_lrange range_acl8113_1_ai = {
	4,
	{
		BIP_RANGE(5),
		BIP_RANGE(2.5),
...
static const comedi_lrange range_acl8113_1_2_ai = {
	4,
	{
		UNI_RANGE(10),
		UNI_RANGE(5),
...
static const comedi_lrange range_acl8113_2_ai = {
	3,
	{
		BIP_RANGE(5),
		BIP_RANGE(2.5),
...
static const comedi_lrange range_acl8113_2_2_ai = {
	3,
	{
		UNI_RANGE(10),
		UNI_RANGE(5),
...
static const comedi_lrange range_a821pgh_ai = {
	4,
	{
		BIP_RANGE(5),
		BIP_RANGE(0.5),
...
{
	int err = 0;
	unsigned int tmp, divisor1, divisor2;
	...
	if (cmd->convert_src == TRIG_TIMER) {
		...
		comedi_check_trigger_arg_min(&tmp, this_board->ai_ns_min);
...
static int pcl812_ai_cmd(comedi_device * dev, comedi_subdevice * s)
{
	...
	if ((devpriv->ai_flags & CMDF_WAKE_EOS)) {	// don't we want wake up every scan?
		devpriv->ai_eos = 1;
