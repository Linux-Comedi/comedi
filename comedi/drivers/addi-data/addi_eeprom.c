...
INT i_EepromReadMainHeader(WORD w_PCIBoardEepromAddress,
	PCSTR pc_PCIChipInformation, comedi_device * dev);

INT i_EepromReadDigitalInputHeader(WORD w_PCIBoardEepromAddress,
	PCSTR pc_PCIChipInformation, WORD w_Address,
...
INT i_EepromReadAnlogInputHeader(WORD w_PCIBoardEepromAddress,
	...
	str_AnalogInputHeader * s_Header);
		...
		/******************************************/
WORD w_EepromReadWord(WORD w_PCIBoardEepromAddress, PCSTR pc_PCIChipInformation,
...
|																	 |
|		      PCSTR pc_PCIChipInformation  : PCI Chip Type.          |
|																	 |
...
|			w_PCIBoardEepromAddress,PCSTR pc_PCIChipInformation,	 |
