	   ...
	   /*************************************/
		...
		for (b_Cpt = 1;
		 ...
		 /************************/
				...
				printk("Port %d direction selection error\n",
					(INT) b_Cpt);
		...
		if ((b_Command == APCI16XX_TTL_WRITECHANNEL_ON) ||
		 ...
		 /***********************/
		    ...
		    /*****************************************/
					...
					printk("Port selection error %lX\n",
		 ...
		 /****************************************/
				...
				printk("Port selection error %d %d\n",
