...
static const comedi_lrange range_pcl818h_ai = {
	9,
	{
		BIP_RANGE(5),
		BIP_RANGE(2.5),
...
static const comedi_lrange range_pcl818hg_ai = {
	10,
	{
		BIP_RANGE(5),
		BIP_RANGE(0.5),
...
static const comedi_lrange range_pcl818l_l_ai = {
	4,
	{
		BIP_RANGE(5),
		BIP_RANGE(2.5),
...
static const comedi_lrange range_pcl818l_h_ai = {
	4,
	{
		BIP_RANGE(10),
		BIP_RANGE(5),
...
static int pcl818_ai_cancel(comedi_device * dev, comedi_subdevice * s)
{
	if (devpriv->irq_blocked > 0) {
		...
		case INT_TYPE_AI3_DMA_RTC:
			...
			timer_delete(&devpriv->rtc_irq_timer);
			fallthrough;
			/* FALLTHROUGH */
#endif
		case INT_TYPE_AI1_DMA:
